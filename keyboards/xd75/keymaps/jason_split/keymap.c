 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+---------
 * | LCTRL  | FN     |        | LGUI   | LALT   | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  |        |        |        |        |        |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */

 [_QW] = { /* QWERTY */
  { KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_MINS, KC_BSLS, KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV  },
  ...
  { KC_LCTL, MO(_FN), _______, KC_LGUI, KC_LALT, KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC,  _______, _______, _______, _______, _______ },
 },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { RESET,   MO(_FN), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_VAI, RGB_VAD },
 }
};
