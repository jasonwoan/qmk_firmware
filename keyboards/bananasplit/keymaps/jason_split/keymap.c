...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEFAULT_LAYER] = KEYMAP_HHKB_ARROW(
    ...
    KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, MO(LAYER_1), \
    KC_LCTL,  KC_LGUI,  KC_LALT, KC_LGUI,      KC_ENT,      KC_SPC,  KC_RALT, KC_LEFT,  KC_DOWN, KC_UP, KC_RIGHT
  ),
